...
namespace TMPro
{
    ...
    public class TMP_SpriteAsset : TMP_Asset
    {
        ...
        public List<Material> AlternativeMaterials
        {
            get { return m_AlternativeMaterials; }
            set { m_AlternativeMaterials = value; }
        }
        [SerializeField]
        private List<Material> m_AlternativeMaterials;
