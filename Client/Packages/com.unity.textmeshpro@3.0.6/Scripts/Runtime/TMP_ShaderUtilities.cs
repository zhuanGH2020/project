...
namespace TMPro
{
    public static class ShaderUtilities
    {
        ...
        // Add by UITC.Player on screen param
        public static int ID_NamebarBGTex;
        ...
        public static int ID_AlwaysTop;
        public static int ID_ZTestMode;

        public static int ID_ExtraScale;
        ...
        public static string Tag_AlwaysTop = "_AlwaysTop";
        public static string Tag_ZTestMode = "_ZMode";
        ...
        public static void GetShaderPropertyIDs()
        {
            if (isInitialized == false)
            {
                ...
                ID_NamebarBGTex = Shader.PropertyToID("_NameBarBgTex");
                ...
                ID_MaxColor = Shader.PropertyToID("_MaxColor");
                ...
                ID_ZTestMode = Shader.PropertyToID(Tag_ZTestMode);
                ID_AlwaysTop = Shader.PropertyToID(Tag_AlwaysTop);

                ID_ExtraScale = Shader.PropertyToID("_ExtraScale");
