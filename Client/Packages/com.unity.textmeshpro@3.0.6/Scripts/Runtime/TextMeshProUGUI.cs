...
namespace TMPro
{
    ...
    public partial class TextMeshProUGUI : TMP_Text, ILayoutElement
    {
        ...
        /// <summary>
        /// Event to allow users to execute some function after the text is rebuild.
        /// </summary>
        public Action<TMP_Text> onRebuildText;
        ...
        {
            bool isCalledByUGUI = (!m_isMaterialDirty && !m_isLayoutDirty) ? true : false;
        ...
        protected override void UpdateMaterial()
        {
            ...
            if(m_useSpriteOnly)
                m_canvasRenderer.SetMaterial(m_spriteAsset.material, 0);
            else
