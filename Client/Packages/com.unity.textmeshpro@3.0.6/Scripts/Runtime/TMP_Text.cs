...
namespace TMPro
{
    ...
    public enum LinkedOverflowExtraModes
    {
        Default = 0,
        SingleChar = 1,
        TextElement = 2
    ...
    public abstract class TMP_Text : MaskableGraphic
    {
        ...
        public virtual string text
        {
            ...
            set
            {
                ...
                ////TMP Thai Parse
                //if (ThaiFontAdjuster.enable && ThaiFontAdjuster.IsThaiString(value))
                //    m_text = ThaiFontAdjuster.Adjust(value);
                //else
                m_text = value;
        ...
        [SerializeField] [TextArea(5, 10)] protected string m_text;
        private string lastText;
        public void GetThaiWordBreakPos()
        {
            if (TMP_Settings.curLanguage != "th")
                return;

            if ( m_thaiWordBreakPosList == null)
                m_thaiWordBreakPosList = new List<int>();
            m_thaiWordBreakPosList.Clear();

            if(string.IsNullOrEmpty(m_text))
                return;

            int strIndex = 0;
            while (strIndex < m_text.Length)
            { 
                var curWordEnd = TMP_Settings.thaiWordTree.FindWordWithCandidate(m_text, strIndex);
                if (curWordEnd < 0)
                    curWordEnd = strIndex;
                m_thaiWordBreakPosList.Add(curWordEnd);
                strIndex = curWordEnd + 1;
            }
        }

        public int GetNextThaiBreakPos(int curIndex)
        {
            if(curIndex >= m_text.Length)
                return -1;

            if (m_thaiWordBreakPosList == null || lastText != m_text)
            { 
                lastText = m_text;
                GetThaiWordBreakPos();
            }

            var index = m_thaiWordBreakPosList.BinarySearch(curIndex);
            if (index < 0)
            { 
                index = ~index;
            }

            if (index < m_thaiWordBreakPosList.Count)
                return m_thaiWordBreakPosList[index];
            else
                return -1;
        }

        public List<int> thaiWordBreakPosList
        {
            get { return m_thaiWordBreakPosList; }
        }
        private List<int> m_thaiWordBreakPosList;

        //Add by UITC. Need update after text localized
        public bool needLocalizedUpdate = false;
        ...
        [SerializeField] protected ITextPreprocessor m_TextPreprocessor;
        ...
        protected TMP_FontAsset m_targetFontAsset;
        protected bool m_isSDFShader;

        [SerializeField] protected TMP_FontAsset[] m_overrideFontAssets;
        public TMP_FontAsset[] overrideFontAsset
        {
            get { return m_overrideFontAssets; }
            set
            {
                m_overrideFontAssets = value;
            }
        }

        private TMP_FontAsset m_initFontAsset;
        private int m_overrideFontAssetIndexInner;
        [SerializeField] protected int m_overrideFontAssetIndex;
        public int overrideFontAssetIndex
        {
            get { return m_overrideFontAssetIndexInner; }
            set
            {
                if (value == m_overrideFontAssetIndexInner)
                    return;

                m_overrideFontAssetIndexInner = value;
                if (m_overrideFontAssets.Length > 0 && value < m_overrideFontAssets.Length)
                {
                    var fontAsset = m_overrideFontAssets[value];
        ...
        protected override void OnDidApplyAnimationProperties()
        {
            ...
            if (m_overrideFontAssetIndex != overrideFontAssetIndex)
            {
                overrideFontAssetIndex = m_overrideFontAssetIndex;
            }
        }
        ...
        [SerializeField] protected Color32 m_fontColor32 = Color.white;
        ...
        [SerializeField] protected VertexGradient m_fontColorGradient = new VertexGradient(Color.white);
        ...
        [SerializeField] protected TMP_ColorGradient m_fontColorGradientPreset;
        ...
        [SerializeField] protected TMP_SpriteAsset m_spriteAsset;

        /// <summary>
        /// 替换Sprite材质球Index
        /// </summary>
        public int spriteMaterialIndex
        {
            get { return m_spriteMaterialIndex; }
            set 
            {
                m_spriteMaterialIndex = value;
                m_havePropertiesChanged = true;
                SetVerticesDirty();
                SetLayoutDirty();
            }
        }
        [SerializeField] protected int m_spriteMaterialIndex;
        ...
        [SerializeField] protected TMP_StyleSheet m_StyleSheet;
        ...
        [SerializeField] protected int m_TextStyleHashCode;
        ...
        public bool overrideColorTags
        {
            ...
            set
            {
                if (m_overrideHtmlColors == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected bool m_overrideHtmlColors = false;
        ...
        public Color32 faceColor
        {
            ...
            set
            {
                if (m_faceColor.Compare(value)) return;
                SetFaceColor(value);
                m_havePropertiesChanged = true;
                m_faceColor = value;
                SetVerticesDirty();
        ...
        [SerializeField] protected Color32 m_faceColor = Color.white;
        ...
        public Color32 outlineColor
        {
            ...
            set
            {
                if (m_outlineColor.Compare(value)) return;
        ...
        public float fontSize
        {
            ...
            set
            {
                ...
                m_havePropertiesChanged = true;
                m_fontSize = value;
                if (!m_enableAutoSizing) m_fontSizeBase = m_fontSize;
                SetVerticesDirty();
                SetLayoutDirty();
            }
        }

        [SerializeField] protected float m_fontSize = -99; // Font Size
        ...
        [SerializeField] protected FontWeight m_fontWeight = FontWeight.Regular;
        ...
        public bool enableAutoSizing
        {
            ...
            set
            {
                if (m_enableAutoSizing == value) return;
        ...
        public bool AutoSizeInitOnce
        {
            get { return m_autoSizeInitOnce; }
            set
            {
                if (value == m_autoSizeInitOnce)
                    return;
                m_IsAutoSizeInited = false;
                m_autoSizeInitOnce = value;
                SetVerticesDirty();
                SetLayoutDirty();
            }
        }

        [SerializeField] protected bool m_autoSizeInitOnce = false;
        protected bool m_IsAutoSizeInited = false;
        ...
        [SerializeField] protected float m_fontSizeMin = 0; // Text Auto Sizing Min Font Size.
        ...
        [SerializeField] protected float m_fontSizeMax = 0; // Text Auto Sizing Max Font Size.
        ...
        public float characterSpacing
        {
            ...
            set
            {
                if (m_characterSpacing == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected float m_characterSpacing = 0;
        ...
        [SerializeField] protected float m_wordSpacing = 0;
        ...
        public float lineSpacingAdjustment
        {
            ...
            set
            {
                if (m_lineSpacingMax == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected float m_lineSpacingMax = 0; // Text Auto Sizing Max Line spacing reduction.
        ...
        public float paragraphSpacing
        {
            ...
            set
            {
                if (m_paragraphSpacing == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected float m_paragraphSpacing = 0;
        ...
        public float characterWidthAdjustment
        {
            ...
            set
            {
                if (m_charWidthMaxAdj == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected float m_charWidthMaxAdj = 0f; // Text Auto Sizing Max Character Width reduction.
        ...
        public bool enableWordWrapping
        {
            ...
            set
            {
                if (m_enableWordWrapping == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected bool m_enableWordWrapping = false;
        ...
        public float wordWrappingRatios
        {
            ...
            set
            {
                if (m_wordWrappingRatios == value) return;
        ...
        [SerializeField] protected float m_wordWrappingRatios = 0.4f; // Controls word wrapping ratios between word or characters.
        ...
        public LinkedOverflowExtraModes LinkedOverflowExtraMode
        {
            get { return m_LinkedOverflowExtraMode; }
            set
            {
                if (m_LinkedOverflowExtraMode == value)
                    return;
                m_LinkedOverflowExtraMode = value;
                m_havePropertiesChanged = true;
                SetVerticesDirty();
                SetLayoutDirty();
            }
        ...
        [SerializeField] protected LinkedOverflowExtraModes m_LinkedOverflowExtraMode;
        ...
        public bool isTextOverflowing
        {
            get
            {
                if (m_firstOverflowCharacterIndex != -1) return true;
                return false;
            }
        }
        ...
        [SerializeField] protected TMP_Text m_linkedTextComponent;
        [SerializeField] internal TMP_Text parentLinkedComponent;
        ...
        public bool enableKerning
        {
            ...
            set
            {
                if (m_enableKerning == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected bool m_enableKerning;
        ...
        public bool extraPadding
        {
            ...
            set
            {
                if (m_enableExtraPadding == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected bool m_enableExtraPadding = false;
        [SerializeField] protected bool checkPaddingRequired;

        public bool isInit = false;
        public bool isASimpleJumpWord = false;


        /// <summary>
        /// If use sprite asset only, set sprite mesh into main mesh and not generate submeshUI anymore.
        /// </summary>
        public bool useSpriteOnly
        {
            get { return m_useSpriteOnly; }
            set
            {
                if (m_useSpriteOnly == value) return;
                m_havePropertiesChanged = true;
                SetVerticesDirty();
                SetLayoutDirty();
            }
        ...
        [SerializeField]
        protected bool m_useSpriteOnly = false;

        /// <summary>
        /// Disable character spacing in thai language
        /// </summary>
        public bool disableCharacterSpacingInThai
        {
            get { return m_disableCharacterSpacingInThai; }
            set
            {
                if (m_disableCharacterSpacingInThai == value) return;
                m_havePropertiesChanged = true;
                SetVerticesDirty();
                SetLayoutDirty();
            }
        ...
        [SerializeField]
        protected bool m_disableCharacterSpacingInThai = false;

        /// <summary>
        /// Use Itlic Override. Add by UITC.
        /// </summary>
        public bool uesItlicOverride
        {
            get { return m_uesItalicOverride; }
            set
            {
                if (m_uesItalicOverride == value) return;
                m_havePropertiesChanged = true;
                m_uesItalicOverride = value; /*SetVerticesDirty(); SetLayoutDirty();*/
            }
        }

        [SerializeField] protected bool m_uesItalicOverride = false;

        /// <summary>
        /// Itlic Override Value. Add by UITC.
        /// </summary>
        [SerializeField]
        public int italicOverrideValue
        {
            get { return m_italicOverrideValue; }
            set
            {
                if (m_italicOverrideValue == value) return;
                m_havePropertiesChanged = true;
                m_italicOverrideValue = value; /*SetVerticesDirty(); SetLayoutDirty();*/
            }
        }

        [SerializeField] protected int m_italicOverrideValue;

        /// <summary>
        /// Thai language is enforced. Add by UITC.
        /// </summary>
        /// 
        public bool forceAdjustAllLanguage
        {
            get { return m_forceAdjustAllLanguage; }
            set
            {
                if (m_forceAdjustAllLanguage == value) return;
                m_havePropertiesChanged = true;
                m_forceAdjustAllLanguage = value; /*SetVerticesDirty(); SetLayoutDirty();*/
            }
        }

        [SerializeField] protected bool m_forceAdjustAllLanguage = false;


        public bool useOSFontFallback
        {
            get { return m_useOSFontFallback; }
            set
            {
                if (m_useOSFontFallback == value)
                    return;
                m_useOSFontFallback = value;
            }
        }

        [SerializeField] protected bool m_useOSFontFallback = false;
        ...
        [SerializeField] protected bool m_isRichText = true; // Used to enable or disable Rich Text.
        ...
        public bool parseCtrlCharacters
        {
            ...
            set
            {
                if (m_parseCtrlCharacters == value) return;
        ...
        public bool isOrthographic
        {
            ...
            set
            {
                if (m_isOrthographic == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected bool m_isOrthographic = false;
        ...
        public bool enableCulling
        {
            ...
            set
            {
                if (m_isCullingEnabled == value) return;
        ...
        [SerializeField] protected bool m_isCullingEnabled = false;
        ...
        public bool ignoreVisibility
        {
            ...
            set
            {
                if (m_ignoreCulling == value) return;
                m_havePropertiesChanged = true;
        ...
        public TextureMappingOptions horizontalMapping
        {
            ...
            set
            {
                if (m_horizontalMapping == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected TextureMappingOptions m_horizontalMapping = TextureMappingOptions.Character;
        ...
        public TextureMappingOptions verticalMapping
        {
            ...
            set
            {
                if (m_verticalMapping == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected TextureMappingOptions m_verticalMapping = TextureMappingOptions.Character;
        ...
        public float mappingUvLineOffset
        {
            ...
            set
            {
                if (m_uvLineOffset == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected float m_uvLineOffset = 0.0f; // Used for UV line offset per line
        ...
        [SerializeField] protected VertexSortingOrder m_geometrySortingOrder;
        ...
        [SerializeField] protected bool m_IsTextObjectScaleStatic;
        ...
        [SerializeField] protected bool m_VertexBufferAutoSizeReduction = false;
        ...
        public int maxVisibleCharacters
        {
            ...
            set
            {
                if (m_maxVisibleCharacters == value) return;
                m_havePropertiesChanged = true;
        ...
        public int maxVisibleWords
        {
            ...
            set
            {
                if (m_maxVisibleWords == value) return;
                m_havePropertiesChanged = true;
        ...
        public int maxVisibleLines
        {
            ...
            set
            {
                if (m_maxVisibleLines == value) return;
                m_havePropertiesChanged = true;
        ...
        public bool useMaxVisibleDescender
        {
            ...
            set
            {
                if (m_useMaxVisibleDescender == value) return;
                m_havePropertiesChanged = true;
        ...
        [SerializeField] protected Vector4 m_margin = new Vector4(0, 0, 0, 0);
        ...
        [SerializeField] protected bool m_isUsingLegacyAnimationComponent;
        ...
        public bool isVolumetricText
        {
            ...
            set
            {
                if (m_isVolumetricText == value) return;
                m_havePropertiesChanged = value;
        ...
        protected int m_lastThaiWordIndex;
        protected int m_ThaiWordEndIndex;
        ...
        protected void ParseInputText()
        {
            ...
            //Thai Adjsut
            //m_forceAdjustAllLanguage
            if (m_forceAdjustAllLanguage || (ThaiFontAdjuster.enable && m_fontAsset.fallbackFontAssetTable.Count > 0))
            {
                if (ThaiFontAdjuster.IsThaiString(m_text))
                    m_text = ThaiFontAdjuster.Adjust(m_text);
            }

            else if (TMP_Settings.curLanguage == "vn")
            {
                m_text = VnFontAdjuster.Adjust(m_text);
            }
        ...
        protected virtual void FillCharacterVertexBuffers(int i, int index_X4, int currentLine)
        {
            ...
            // Setup UVS3
            //float minY = 
            m_textInfo.meshInfo[materialIndex].uvs3[0 + index_X4] = characterInfoArray[i].vertex_BL.uv4;
            m_textInfo.meshInfo[materialIndex].uvs3[1 + index_X4] = characterInfoArray[i].vertex_TL.uv4;
            m_textInfo.meshInfo[materialIndex].uvs3[2 + index_X4] = characterInfoArray[i].vertex_TR.uv4;
            m_textInfo.meshInfo[materialIndex].uvs3[3 + index_X4] = characterInfoArray[i].vertex_BR.uv4;

            //m_textInfo.meshInfo[materialIndex].uvs3[0 + index_X4] = Vector2.one * 0.5f;
            //m_textInfo.meshInfo[materialIndex].uvs3[1 + index_X4] = Vector2.one * 0.5f;
            //m_textInfo.meshInfo[materialIndex].uvs3[2 + index_X4] = Vector2.one * 0.5f;
            //m_textInfo.meshInfo[materialIndex].uvs3[3 + index_X4] = Vector2.one * 0.5f;
        ...
        protected virtual void FillCharacterVertexBuffers(int i, int index_X4, bool isVolumetric, int currentLine)
        {
            int materialIndex = m_textInfo.characterInfo[i].materialReferenceIndex;
            index_X4 = m_textInfo.meshInfo[materialIndex].vertexCount;
        ...
        protected virtual void FillSpriteVertexBuffers(int i, int index_X4, int currentLine)
        {
            int materialIndex = m_textInfo.characterInfo[i].materialReferenceIndex;
            index_X4 = m_textInfo.meshInfo[materialIndex].vertexCount;
            ...
            // Setup UVS3
            //m_textInfo.meshInfo[materialIndex].uvs3[0 + index_X4] = new Vector2(currentLine, 0f);
            //m_textInfo.meshInfo[materialIndex].uvs3[1 + index_X4] = new Vector2(currentLine, 0f);
            //m_textInfo.meshInfo[materialIndex].uvs3[2 + index_X4] = new Vector2(currentLine, 0f); 
            //m_textInfo.meshInfo[materialIndex].uvs3[3 + index_X4] = new Vector2(currentLine, 0f);
            m_textInfo.meshInfo[materialIndex].uvs3[0 + index_X4] = characterInfoArray[i].vertex_BL.uv4;
            m_textInfo.meshInfo[materialIndex].uvs3[1 + index_X4] = characterInfoArray[i].vertex_TL.uv4;
            m_textInfo.meshInfo[materialIndex].uvs3[2 + index_X4] = characterInfoArray[i].vertex_TR.uv4;
            m_textInfo.meshInfo[materialIndex].uvs3[3 + index_X4] = characterInfoArray[i].vertex_BR.uv4;
        ...
        protected void GetEllipsisSpecialCharacter(TMP_FontAsset fontAsset)
        {
            ...
            TMP_Character character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(0x2026, fontAsset, false, false, m_FontStyleInternal, m_FontWeightInternal, null,  out isUsingAlternativeTypeface);
            TMP_FontAsset targetFontAsset = fontAsset.packAtlasTexture ? fontAsset : null; 
            if (character == null)
            {
                // Search primary fallback list
                if (fontAsset.m_FallbackFontAssetTable != null && fontAsset.m_FallbackFontAssetTable.Count > 0)
                    character = TMP_FontAssetUtilities.GetCharacterFromFontAssets(0x2026, fontAsset, fontAsset.m_FallbackFontAssetTable, true, false, m_FontStyleInternal, m_FontWeightInternal, targetFontAsset,out isUsingAlternativeTypeface);
            }
            ...
            if (character == null)
            {
                if (TMP_Settings.fallbackFontAssets != null && TMP_Settings.fallbackFontAssets.Count > 0)
                    character = TMP_FontAssetUtilities.GetCharacterFromFontAssets(0x2026, fontAsset, TMP_Settings.fallbackFontAssets, true, false, m_FontStyleInternal, m_FontWeightInternal, targetFontAsset, out isUsingAlternativeTypeface);
            }
            ...
            if (character == null)
            {
                if (TMP_Settings.defaultFontAsset != null)
                    character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(0x2026, TMP_Settings.defaultFontAsset, true, false, m_FontStyleInternal, m_FontWeightInternal, targetFontAsset, out isUsingAlternativeTypeface);
            }

            // Search TMP Settings' default os font asset
            if (character == null /* && m_useOSFontFallback*/)
            {
                if (TMP_Settings.defaultOSFontAsset != null)
                {
                    character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(0x2026, TMP_Settings.defaultOSFontAsset, false, true, m_FontStyleInternal, m_FontWeightInternal, targetFontAsset, out isUsingAlternativeTypeface);
                }
            }
        ...
        //hack @wangqingyu
        public int GetUnderlineMaterialIndex()
        {
            return m_Underline.materialIndex;
        }
        ...
        protected void GetUnderlineSpecialCharacter(TMP_FontAsset fontAsset)
        {
            ...
            TMP_Character character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(0x5F, fontAsset, false, false, FontStyles.Normal, FontWeight.Regular, null, out isUsingAlternativeTypeface);
        ...
        {
            TMP_Character character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(unicode, fontAsset, false, false, fontStyle, fontWeight, null, out isUsingAlternativeTypeface);

            if (character != null)
                return character;

            TMP_FontAsset targetFontAsset = m_fontAsset.packAtlasTexture ? m_fontAsset : null;
            // Search potential list of fallback font assets assigned to the font asset.
            if (fontAsset.m_FallbackFontAssetTable != null && fontAsset.m_FallbackFontAssetTable.Count > 0)
                character = TMP_FontAssetUtilities.GetCharacterFromFontAssets(unicode, fontAsset, fontAsset.m_FallbackFontAssetTable, true, false, fontStyle, fontWeight, targetFontAsset, out isUsingAlternativeTypeface);
            ...
            if (fontAsset.instanceID != m_fontAsset.instanceID)
            {
                ...
                character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(unicode, m_fontAsset, false, false, fontStyle, fontWeight, targetFontAsset, out isUsingAlternativeTypeface);
                ...
                if (m_fontAsset.m_FallbackFontAssetTable != null && m_fontAsset.m_FallbackFontAssetTable.Count > 0)
                    character = TMP_FontAssetUtilities.GetCharacterFromFontAssets(unicode, fontAsset, m_fontAsset.m_FallbackFontAssetTable, true, false, fontStyle, fontWeight, targetFontAsset, out isUsingAlternativeTypeface);
            ...
            if (TMP_Settings.fallbackFontAssets != null && TMP_Settings.fallbackFontAssets.Count > 0)
                character = TMP_FontAssetUtilities.GetCharacterFromFontAssets(unicode, fontAsset, TMP_Settings.fallbackFontAssets, true, false, fontStyle, fontWeight, targetFontAsset, out isUsingAlternativeTypeface);
            ...
            if (TMP_Settings.defaultFontAsset != null)
                character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(unicode, TMP_Settings.defaultFontAsset, true, false, fontStyle, fontWeight, targetFontAsset, out isUsingAlternativeTypeface);
            ...
            // Search for the character in the Default OS Font Asset assigned in the TMP Settings file.
            if (TMP_Settings.defaultOSFontAsset != null)
            {
                character = TMP_FontAssetUtilities.GetCharacterFromFontAsset(unicode, TMP_Settings.defaultOSFontAsset, false, true, fontStyle, fontWeight, targetFontAsset, out isUsingAlternativeTypeface);
            }
        ...
        public float PackIntToFloat(int x, int y)
        {
            uint uintA = (uint)x;
            uint uintB = (uint)y;
            uint combined = (uintA << 16) | (uintB & 0xFFFF);
            float converted = BitConverter.ToSingle(BitConverter.GetBytes(combined), 0);
        ...
        internal bool ValidateHtmlTag(UnicodeChar[] chars, int startIndex, out int endIndex)
        {
            ...
            else
            {
                ...
                switch (m_xmlAttribute[0].nameHashCode)
                {
                    ...
                    case 105: // <i>
                    case 73: // <I>
                        if (TMP_Settings.curLanguage == "kr")
                            return true;
                    ...
                    case 1619421: // <SPRITE>
                        ...
                        if(m_spriteMaterialIndex == 0)
                            ...
                            m_currentMaterialIndex = MaterialReference.AddMaterialReference(m_currentSpriteAsset.AlternativeMaterials[m_spriteMaterialIndex - 1], m_currentSpriteAsset, ref m_materialReferences, m_materialReferenceIndexLookup);
