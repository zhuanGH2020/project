...
namespace TMPro.EditorUtilities
{
    ...
    public class TMP_SettingsEditor : Editor
    {
        internal class Styles
        {
            ...
            public static readonly GUIContent defaultOSFontAssetLabel = new GUIContent("Default OS Font Asset", "The Font Asset will be used as the last fallback step to load characters from the system.");
            ...
            public static readonly GUIContent fallbackOSFontsLabel = new GUIContent("Fallback OS Fonts", "使用系统字体作为Fallback.从系统目录直接读取Font Face");
            public static readonly GUIContent fallbackOSFontsCommonListLabel = new GUIContent("Common OS Fonts List", ".");
            public static readonly GUIContent fallbackOSFontsAndroidListLabel = new GUIContent("Android OS Fonts List", ".");
            public static readonly GUIContent fallbackOSFontsWindowsListLabel = new GUIContent("Windows OS Fonts List", ".");
            public static readonly GUIContent fallbackOSFontsIOSListLabel = new GUIContent("IOS OS Fonts List", ".");
        ...
        SerializedProperty m_PropOSFontAsset;
        ...
        ReorderableList m_osCommonList;
        ReorderableList m_osAndroidList;
        ReorderableList m_osWindowsList;
        ReorderableList m_osIOSList;
        ...
        SerializedProperty m_PropThaiWordsDictionary;
        ...
        public void OnEnable()
        {
            ...
            m_PropOSFontAsset = serializedObject.FindProperty("m_defaultOSFontAsset");
            ...
            m_List = InitReorderableList("m_fallbackFontAssets", Styles.fallbackFontAssetsListLabel);
            m_osCommonList = InitReorderableList("m_fallbackOSFontsCommon", Styles.fallbackOSFontsCommonListLabel);
            m_osAndroidList = InitReorderableList("m_fallbackOSFontsAndroid", Styles.fallbackOSFontsAndroidListLabel);
            m_osWindowsList = InitReorderableList("m_fallbackOSFontsWindows", Styles.fallbackOSFontsWindowsListLabel);
            m_osIOSList = InitReorderableList("m_fallbackOSFontsIOS", Styles.fallbackOSFontsIOSListLabel);
            ...
            m_PropThaiWordsDictionary = serializedObject.FindProperty( "m_thaiWordsDictionary" );
            m_PropUseModernHangulLineBreakingRules = serializedObject.FindProperty("m_UseModernHangulLineBreakingRules");
        }

        public ReorderableList InitReorderableList(string propertyName, GUIContent label)
        {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_PropOSFontAsset, Styles.defaultOSFontAssetLabel);
            ...
            // FALLBACK OS FONT
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            GUILayout.Label(Styles.fallbackOSFontsLabel, EditorStyles.boldLabel);
            m_osCommonList.DoLayoutList();
            m_osAndroidList.DoLayoutList();
            m_osWindowsList.DoLayoutList();
            m_osIOSList.DoLayoutList();
            EditorGUILayout.EndVertical();
            ...
            EditorGUILayout.PropertyField( m_PropThaiWordsDictionary );
            ...
            if (GUILayout.Button("Clear os fallback list"))
            {
                TMP_Settings.ClearOSFallback();
            }
			if( GUILayout.Button( "Claer thai word tree" ) )
            {
                TMP_Settings.ClearThaiWordTree();
            }
        }
    }
