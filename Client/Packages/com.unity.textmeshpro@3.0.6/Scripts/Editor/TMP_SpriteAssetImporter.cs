...
namespace TMPro
{
    public class TMP_SpriteAssetImporter : EditorWindow
    {
        ...
        void SaveSpriteAsset(string filePath)
        {
            ...
            // Save Sprite Asset
            AssetDatabase.DeleteAsset(pathNoExt + ".asset");
            AssetDatabase.CreateAsset(m_SpriteAsset, pathNoExt + ".asset");
            AssetDatabase.SaveAssets();

            // Add new default material for sprite asset.
            string matPathNotExt = pathNoExt + "_mat";
            AddDefaultMaterial(m_SpriteAsset, pathNoExt, matPathNotExt);
        }
        ...
        static void AddDefaultMaterial(TMP_SpriteAsset spriteAsset, string assetPathNoExt, string matPathNotExt)
        {
            ...
            string matPath = matPathNotExt + ".mat";
            AssetDatabase.DeleteAsset(matPath);
            AssetDatabase.CreateAsset(material, matPath);
            AssetDatabase.SaveAssets();
            
            string assetPath = assetPathNoExt + ".asset";
            var loadedSpriteAsset = AssetDatabase.LoadAssetAtPath<TMP_SpriteAsset>(assetPath); 
            loadedSpriteAsset.material = AssetDatabase.LoadAssetAtPath<Material>(matPath);
