...
namespace TMPro.EditorUtilities
{
    public abstract class TMP_BaseEditorPanel : Editor
    {
        ...
        static readonly GUIContent k_LinkedOverflowLabel = new GUIContent( "Linked Mode", "LinkedOverflow下的额外分词设置. Default-TMP默认 | SingleChar-单个字符 | TextElemet-单个字(泰语带音标)" );
        ...
        static readonly GUIContent k_UseAlternativeMaterialsLabel = new GUIContent( "替换Sprite材质", "选择SpriteAsset上定义的替换材质." );
        static readonly GUIContent k_AlternativeMaterialListLabel = new GUIContent( "替换材质列表", "可供替换的材质列表." );
        ...
        static readonly GUIContent k_AutoAdjustLabel = new GUIContent( "Auto Adjust", "Auto localize text. For example Thai language. Add by uitc." );
        ...
        protected SerializedProperty m_LinkedOverflowExtraModeProp;
        ...
        protected SerializedProperty m_EnableAutoAdjustProp;
        ...
        protected SerializedProperty m_SpriteAssetMaterialIndexProp;

        protected SerializedProperty m_UseAlternativeMaterials;
        protected SerializedProperty m_AlternativeMaterialsList;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_LinkedOverflowExtraModeProp = serializedObject.FindProperty("m_LinkedOverflowExtraMode");
            ...
            m_EnableAutoAdjustProp = serializedObject.FindProperty( "m_enableAutoAdjust" );
            ...
            m_SpriteAssetMaterialIndexProp = serializedObject.FindProperty("m_spriteMaterialIndex");

            m_UseAlternativeMaterials = serializedObject.FindProperty("m_UseAlternativeMaterials");
            m_AlternativeMaterialsList = serializedObject.FindProperty("m_AlternativeMaterials");
        ...
        void DrawWrappingOverflow()
        {
            ...
            if( (TextOverflowModes)m_TextOverflowModeProp.enumValueIndex == TextOverflowModes.Linked )
            {
                ...
                EditorGUILayout.PropertyField(m_LinkedOverflowExtraModeProp, k_LinkedOverflowLabel);
            }
        ...
        protected void DrawSpriteAsset()
        {
            ...
            TMP_SpriteAsset spriteAsset = (TMP_SpriteAsset)m_SpriteAssetProp.objectReferenceValue;
            if (spriteAsset != null)
            {
                List<string> matNames = new List<string>();
                matNames.Add(spriteAsset.material.name);
                if (spriteAsset.AlternativeMaterials != null)
                {
                    for (int i = 0; i < spriteAsset.AlternativeMaterials.Count; i++)
                    {
                        matNames.Add(spriteAsset.AlternativeMaterials[i].name);
                    }
                }
                var numArray = new int[matNames.Count];
                for (int i = 0; i < numArray.Length; i++)
                {
                    numArray[i] = i;
                }

                var index = EditorGUILayout.IntPopup("可选材质", m_SpriteAssetMaterialIndexProp.intValue, matNames.ToArray(), numArray);
                m_SpriteAssetMaterialIndexProp.intValue = index;
                //EditorGUILayout.PropertyField( m_UseAlternativeMaterials, k_UseAlternativeMaterialsLabel, true );
            }
