...
namespace TMPro.EditorUtilities
{
    ...
    public class TMP_FontAssetEditor : Editor
    {
        ...
        private SerializedProperty m_PackAtlasTexture_prop;
        ...
        public void OnEnable()
        {
            ...
            m_PackAtlasTexture_prop = serializedObject.FindProperty("m_packAtlasTexture");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (UI_PanelState.generationSettingsPanel)
            {
                ...
                EditorGUI.BeginDisabledGroup(sourceFont == null);
                {
                    ...
                    EditorGUILayout.PropertyField(m_PackAtlasTexture_prop, new GUIContent("PackAtlasTexture", "Pack all character into the primary font asset's atlas texture. Add by UITC."));
            ...
            if (UI_PanelState.fontFeatureTablePanel)
            {
                ...
                if (GUILayout.Button("Add New Glyph Adjustment Record"))
                {
                    ...
                    if (!m_fontAsset.characterLookupTable.ContainsKey(firstCharacter))
                        m_fontAsset.TryAddCharacterInternal(firstCharacter, false, m_fontAsset.packAtlasTexture ? m_fontAsset : null, out character);
                    ...
                    if (!m_fontAsset.characterLookupTable.ContainsKey(secondCharacter))
                        m_fontAsset.TryAddCharacterInternal(secondCharacter, false, m_fontAsset.packAtlasTexture ? m_fontAsset : null, out character);
            ...
            if (GUILayout.Button("ClearDynamicData"))
            {
