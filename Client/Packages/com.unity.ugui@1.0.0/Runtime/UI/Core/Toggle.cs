...
namespace UnityEngine.UI
{
    ...
    {
#if UNITY_EDITOR
        public static Action<GameObject> OnToggleClickRecordHandler;
#endif
        /// <summary>
        ...
        private static readonly int _isOnParam = Animator.StringToHash("IsOn");
#endif
        ...
        protected override void OnEnable()
        {
            ...
            PlayEffect(true);
#if PACKAGE_ANIMATION
            if (animator && transition == Transition.Animation)
            {
                animator.SetBool(_isOnParam, isOn);
            }
#endif
        }
        ...
        private void InternalToggle()
        {
            if (!IsActive() || !IsInteractable())
                return;
#if UNITY_EDITOR
            OnToggleClickRecordHandler?.Invoke(gameObject);
#endif
            isOn = !isOn;
        }
