...
namespace UnityEngine.UI
{
    ...
    public abstract class MaskableGraphic : Graphic, IClippable, IMaskable, IMaterialModifier
    {
        ...
        // [SerializeField]
        private CullStateChangedEvent m_OnCullStateChanged = null;
        ...
        {
            get { return m_OnCullStateChanged ??= new CullStateChangedEvent(); }
        ...
        protected override void OnCanvasHierarchyChanged()
        {
            ...
            if (!GUIRuntimeSettings.OpenOnCanvasHierarchyChanged)
            {
                return;
            }
