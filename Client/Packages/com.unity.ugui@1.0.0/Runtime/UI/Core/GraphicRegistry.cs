...
namespace UnityEngine.UI
{
    ...
    public class GraphicRegistry
    {
        ...
        public static void UnregisterGraphicForCanvas(Canvas c, Graphic graphic)
        {
            ...
            //因为RegisterRaycastGraphicForCanvas的时候并没有判断是在m_Graphics中存在，所以UnregisterRaycastGraphicForCanvas的时候也不需要判断，否则会出现无法移除的情况。
            //目前已知在激活时通过set raycastTarget为true，引发RegisterRaycastGraphicForCanvas，此时还没有执行过RegisterGraphicForCanvas，紧接着更改所属canvas，引发UnregisterGraphicForCanvas，若判断是否在m_Graphics中存在，会导致无法移除。
