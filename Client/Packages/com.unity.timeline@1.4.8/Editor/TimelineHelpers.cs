...
{
    public static class TimelineHelpersForIGame
    {
        public static void CloneAnimationInfiniteClip(AnimationTrack target, AnimationTrack origin, PlayableAsset originAsset)
        {
            target.infiniteClip = CloneAnimationClip(origin.infiniteClip, originAsset);
        }
        
        public static AnimationClip CloneAnimationClip(AnimationClip clip, Object owner)
        {
            return TimelineHelpers.CloneAnimationClip(clip, owner);
        }
    }
