...
namespace UnityEditor.Timeline
{
    ...
    [MenuEntry("Skill Fx/Convert Record To AnimationClip", MenuPriority.BattleSkillEditor.RecordToAnim), UsedImplicitly]
    class BattleSkillEditRecordToAnimationModeAction : ClipAction
    {
        public override bool Execute(IEnumerable<TimelineClip> clips)
        {
            foreach (var clip in clips)
                clip.BattleSkillEditRecordToAnimationClipMode();
