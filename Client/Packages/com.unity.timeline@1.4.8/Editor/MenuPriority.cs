...
namespace UnityEditor.Timeline.Actions
{
    ...
    public static class MenuPriority
    {
        ...
        public static class BattleSkillEditor
        {
            public const int defaultValue = 20000 + separatorAt;
            public const int convertClip = 20000 + separatorAt;
            public const int RecordToAnim = 20000 + separatorAt;
        }
    }
}
